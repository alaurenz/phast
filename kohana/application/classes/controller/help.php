...
class Controller_Help extends Controller {
    ...
    public function action_index($selected_tab = "")
    {
        $view = View::factory('template');
        $view->page_title = "Help documentation";
        $view->page_content = View::factory('pages/help');
        $view->nav_active = "";
        
        $view->page_content->selected_tab = $selected_tab;
